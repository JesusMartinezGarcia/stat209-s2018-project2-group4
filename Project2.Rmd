...
```{r Graph function, echo=FALSE, message=FALSE, warning=FALSE}
...
{HIV_GDP_data <- combined%>% filter(low_GDP< average_GDP & average_GDP < high_GDP & Country != exclude)
...
HIV_GDP_FPlot<- ggplot(HIV_GDP_data, aes(x = Year)) +
